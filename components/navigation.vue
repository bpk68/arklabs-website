      ...
      >
        ...
        <div class="pt-5 pb-6">
          ...
          <div class="mt-6 px-5">
            <NuxtLink
              to="/contact"
              class="inline-flex items-center justify-center w-full px-4 py-1 border border-transparent text-lg font-medium rounded-md text-white bg-brand-red-900 hover:bg-brand-red-500 transition-all duration-300 ease-in-out"
            >
              <span class="mr-3">Let's talk</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
