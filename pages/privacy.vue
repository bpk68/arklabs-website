      ...
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="max-w-xl mt-5 mx-auto text-xl text-brand-cream">
            ...
            collected, used, and shared on our site.
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="relative md:bg-brand-cream md:p-6">
            <div class="lg:grid lg:grid-cols-2 lg:gap-6">
              ...
              >
                ...
                <p>
                  When you visit https://k-tech.systems, referred to as "the
                  Site", we automatically collect certain information about your
                  device, including information about your web browser, IP
                  address, time zone, and some of the cookies that are installed
                  on your device. Additionally, as you browse the Site, we
                  collect information about the individual web pages or products
                  that you view, what websites or search terms referred you to
                  the Site, and information about how you interact with the
                ...
                <ul>
                  ...
                  <li>
                    ...
                    privacy-first analytics provider, to monitor how users use
                    and navigate the site to help improve the content
                  </li>
                </ul>
                ...
                <p>
                  ...
                  you, including your name, (where necessary) your address,
                ...
                <p>
                  ...
                  and delivery of any services paid for, such as the [mentorship
                  program](/mentorship). Additionally, we use this Order
                  Information to:
                </p>
              ...
              >
                ...
                <p>
                  ...
                  example, we use Stripe to collect payments for services, such
                  as the mentorship program. We also use Pirsch Analytics to
                ...
                <p>
                  ...
                  <a href="mailto:hello@k-tech.systems">hello@k-tech.systems</a
                  >.
                </p>
              </div>
            </div>
...
const title = 'Privacy page | Shopify developer in York, Leeds | K-Tech';
const description =
  'K-Tech values and respects your privacy. You can read our privacy policy here.';
