    ...
    title='Terms and conditions | Rob Kendal, freelance developer'
      ...
      <p>
        ...
        <p>
          ...
          conditions. Do not continue to use Rob Kendal if you do not agree to
        ...
        <ul>
          <li>Republish material from Rob Kendal</li>
          <li>Sell, rent or sub-license material from Rob Kendal</li>
          <li>Reproduce, duplicate or copy material from Rob Kendal</li>
          <li>Redistribute content from Rob Kendal</li>
        </ul>
        ...
        <h2>Paid mentorship programs</h2>

        <p>
          Mentorship options start at a free level where appropriate, but there
          are paid options that enable access to further features and higher
          levels of support. Where a paid option is selected, payments will be
          made online via a selected payment provider (currently Stripe)
        ...
        <p>
          Payments will be collected via a selected payment provider (currently
          Stripe) on a monthly basis, commencing on the date of initial purchase
          of any program and repeating each one month period, on or around the
          same day of the month, until cancelled.
        </p>

        <p>
          Should a payment be missed, we reserve the right to suspend all
          mentoring facilities and support. Notification of missed payments will
          be made to the mentee and reasonable opportunity will be given to
          reconcile any missing payments. If missed payments cannot be
          reconciled or made up, all mentoring services will be cancelled
          automatically, immediately and without further warning or notice.
        </p>

        <h3>Refunds</h3>

        <p>
          Unfortunately, there are no refunds or returns available for
          mentorship programs and services.
        </p>

        <h3>Cancellation</h3>

        <p>
          Mentorship programs are provided on a rolling month to month basis
          with no long-term commitment. Mentees are free to cancel whenever they
          wish, providing one full and clear month's notice of cancellation in
          writing (email is acceptable).
        </p>

        <h3>Access to mentoring platforms and facilities</h3>

        <p>
          Any and all access to platforms, software, coding challenges, video
          calls, and mentoring services and support is subject to change based
          on availability of the mentor and the resources involved.
        </p>
