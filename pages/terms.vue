      ...
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="max-w-xl mt-5 mx-auto text-xl text-brand-cream">
            ...
            use of the K-Tech website.
          </p>
        </div>
      </div>
    </div>
    <div
      class="py-16 xl:py-36 px-4 sm:px-6 lg:px-8 bg-brand-cream overflow-hidden"
    >
        ...
        <div class="relative">
          ...
          <div class="relative md:bg-brand-cream md:p-6">
            <div class="lg:grid lg:grid-cols-2 lg:gap-6">
              <div
                class="prose prose-brand prose-lg text-gray-500 lg:max-w-none"
              >
                <h2>Terms and conditions of use</h2>

                <p>
                  By accessing this website we assume you accept these terms and
                  conditions. Do not continue to use the K-Tech website if you
                  do not agree to take all of the terms and conditions stated on
                  this page. Our Terms and Conditions were created with the help
                  of the
                ...
                <p>
                  We employ the use of cookies. By accessing K-Tech, you agreed
                  to use cookies in agreement with the K-Tech's
                ...
                <p>
                  Unless otherwise stated, K-Tech and/or its licensors own the
                  intellectual property rights for all material on K-Tech. All
                  intellectual property rights are reserved. You may access this
                  from K-Tech for your own personal use subjected to
                ...
                <ul>
                  <li>Republish material from K-Tech</li>
                  <li>Sell, rent or sub-license material from K-Tech</li>
                  <li>Reproduce, duplicate or copy material from K-Tech</li>
                  <li>Redistribute content from K-Tech</li>
                </ul>
                ...
                <p>
                  ...
                  the website. K-Tech does not filter, edit, publish or review
                  comments prior to their presence on the website. Comments do
                  not reflect the views and opinions of K-Tech,its agents and/or
                  affiliates. comments reflect the views and opinions of the
                  person who post their views and opinions. To the extent
                  permitted by applicable laws, K-Tech shall not be liable for
                ...
                <p>
                  K-Tech reserves the right to monitor all Comments and to
                ...
                <p>
                  You hereby grant K-Tech a non-exclusive license to use,
              ...
              <div
                class="mt-6 prose prose-brand prose-lg text-gray-500 lg:mt-0"
              >
                ...
                <ul>
                  ...
                  <li>
                    ...
                    non-profit organisations, charity shopping malls, and
                ...
                <p>
                  These organisations may link to our home page, to publications
                ...
                <p>
                  ...
                  organisation does not have any negative records with us; (c)
                  the benefit to us from the visibility of the hyperlink
                  compensates the absence of K-Tech; and (d) the link is in the
                  context of general resource information.
                </p>

                <p>
                  These organisations may link to our home page so long as the
                ...
                <p>
                  ...
                  inform us by sending an e-mail to K-Tech. Please include your
                  name, your organisation name, contact information as well as
                  ...
                  which you would like to link. Wait 2-3 days for a response.
                </p>

                <p>
                  Approved organisations may hyperlink to our website as
                  follows:
                </p>

                <ul>
                  <li>By use of our corporate name (K-Tech); or</li>
                  <li>
                ...
                <p>
                  No use of K-Tech' logo or other artwork will be allowed for
...
const title = 'Terms and conditions | Shopify agency in York, Leeds | K-Tech';
const description = 'Terms and conditions of use of the K-Tech website';
